# Audit — `diagnose-werkzeuge` — Iteration 9
...
🟢 Keine Regression — Σ Ist 85.0 (≥ 84.0 Iter 8).

**Effektivität:** in-range
(1.0 von -2.0 = -50.0% Reach über 1 Fokus-Dim)
...
- `docs/LEARNINGS.md:1685-1740`
- `ea-fc-sbc-optimizer.user.js:1102-1120`
